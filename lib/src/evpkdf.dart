...
List<Uint8List> EvpKDF({
  ...
  final result = <Uint8List>[Uint8List.sublistView(generatedData, 0, keySize)];
  if (ivSize > 0) {
    result.add(Uint8List.sublistView(generatedData, keySize, keySize + ivSize));
  }
  return result;
}
